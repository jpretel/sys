...
public class PanelBarraDoc extends JPanel {
	...
	public PanelBarraDoc() {
		...
		btnNuevo.setIcon(new ImageIcon(new ImageIcon(PanelBarraDoc.class
				.getResource("/main/resources/iconos/nuevo.png")).getImage()
				.getScaledInstance(_ancho, _alto, java.awt.Image.SCALE_DEFAULT)));
		btnNuevo.setToolTipText("Nuevo");
		add(btnNuevo);
		btnEditar
				.setIcon(new ImageIcon(new ImageIcon(PanelBarraDoc.class
		...
		btnSalir.setIcon(new ImageIcon(new ImageIcon(PanelBarraDoc.class
